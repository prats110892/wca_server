...
class TOTAL_POP_TENURE_UNITS_Table(Base_Table):
	...
	def __init__(self) :
		...
		self.columns = Base_Table.columns + ["Owner occupied","1, detached or attached","2 to 4","5 or more","Mobile home","Boat, RV, van, etc.","Estimate; Renter occupied:","1, detached or attached","2 to 4","5 or more","Mobile home","Boat, RV, van, etc.","Total population in occupied housing units by tenure by units in structure","1, detached or attached","2 to 4","5 or more","Mobile home","Boat, RV, van, etc."]
