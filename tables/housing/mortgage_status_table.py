...
class MORTGAGE_STATUS_Table(Base_Table):
	...
	def __init__(self) :
		...
		self.columns = Base_Table.columns + ["Total owner-occupied housing units","With a mortgage, contract to purchase, or similar debt","Without a mortgage","With a mortgage, contract to purchase, or similar debt","With either a second mortgage or home equity loan, but not both: - Second mortgage only","With either a second mortgage or home equity loan, but not both: - Home equity loan only","Both second mortgage and home equity loan","No second mortgage and no home equity loan"]
