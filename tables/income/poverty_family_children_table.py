...
class POVERTY_FAMILY_CHILDREN_Table(Base_Table):
	...
	def __init__(self) :
		...
		self.columns = Base_Table.columns + ["Total number of families","In poverty","At or above poverty","In poverty","In poverty Families with children under 5","In Poverty Families with children under 18","At or above poverty","Not in Poverty Families with children under 5","Not in poverty families under 18"]
