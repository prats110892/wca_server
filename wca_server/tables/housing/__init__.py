...
def getTableName(client_table_name) :
	return {
    		 ...
    		 'Housing_Units' : HOUSEHOLD_UNITS_Table.table_name,
    		 ...
    		 'Race_Householder' : RACE_HOUSHOLDER_Table.table_name,
    		 ...
    		 'Tenure_Year_Stucture_Built' : TENURE_YEAR_STRUCTURE_BUILT_Table.table_name,
